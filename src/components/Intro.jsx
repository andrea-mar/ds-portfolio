    ...
    return(
        <div id="home" className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center min-h-screen p-4 mx-8">
            ...
            <div className="flex flex-col items-center space-y-2 text-gray-800">
                {/* Paragraphs */}
                <p className="text-center font-poppins font-semibold">Hello, I'm</p>
                <p className="text-center font-poppins font-bold text-2xl">Andreea Nistor</p>
                <p className="text-center font-poppins font-semibold">Data Scientist</p>
                ...
                <div className="flex space-x-3 mt-3">
                    <ul class="flex justify-center mt-5 space-x-5">
                        {/* LinkedIn */}
                        <li>
                            <a href="https://www.linkedin.com/in/andreea-nistor-600a5a297/" target="_blank" class="text-gray-500 hover:text-gray-800 dark:hover:text-white dark:text-gray-400">
                        ...
                        {/* Github */}
                        <li>
                            <a href="https://github.com/andrea-mar" target="_blank" class="text-gray-500 hover:text-gray-800 dark:hover:text-white dark:text-gray-400">
                                <svg class="w-10 h-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path fill-rule="evenodd"
                        ...
                        {/* Gmail */} 
                        {/* do not use mailto link. rederict to contact form */}
                        <li>
                            <a href="#contact"
